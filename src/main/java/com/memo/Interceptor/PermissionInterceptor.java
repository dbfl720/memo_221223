...
public class PermissionInterceptor implements HandlerInterceptor {
	...
	private Logger logger = LoggerFactory.getLogger(this.getClass()); // import org.mybatis.logging.LoggerFactory; 제거.
	...
	public boolean preHandle(HttpServletRequest request, 
		...
		if (userId == null && uri.startsWith("/post")) {
			response.sendRedirect("/user/sign_in_view");  // 내가 책임 안지겠다. 에러처러.

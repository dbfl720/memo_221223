	...
	<div class="w-50"> 
		...
		<div class="d-flex justify-content-between  mt-2">
			<div class="d-flex justify-content-end ">   <%-- mx, my 검색!  --%>
				<button type="button" id="postListBtn" class="btn btn-light">목록</button>
				<input class="ml-1 mt-2 text-light" type="file" id="file" multiple='multiple' accept=".jpg, .jpeg, .png, .gif"> <%-- 확장자 선택 가능 : accept=".jpg, .jpeg, .png, .gif" --%>
			</div>
			<div>

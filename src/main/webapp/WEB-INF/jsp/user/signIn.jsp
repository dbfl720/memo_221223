<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div id="wrap" class="container text-center signInBigBox">
			<form id="loginForm" method="POST" action="/user/sign_in">
				...
				<div><button id="loginBtn" name="loginBtn" type="button" class="btn btn-warning col-4 mb-3">LOGIN</button></div>
				<div><a href="/user/sign_up_view"><button id="joinBtn" name="joinBtn" type="button" class="btn btn-warning col-4">JOIN</button></a></div>
			</form>
	</div>
<script>

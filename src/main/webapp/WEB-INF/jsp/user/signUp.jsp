		...
		<form id="signUpForm" method="post" action="/user/sign_up">
			<table class="sign-up-table table table-bordered">
				...
				<tr>		
					...
					<button type="submit" id="signUpBtn" class="btn btn-warning float-right col-12 mt-5 mb-2">Join</button>		
					</td>
				</tr>
			</table>
			<br>
